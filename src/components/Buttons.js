  ...
  return (
    ...
    <div className="flex contents">
      ...
      <div className="p-2">
        <button
          onClick={reset}
          className="flex mx-auto text-black bg-violet-500 border-0 py-2 h-11 px-4 focus:outline-none hover:bg-green-600 hover:text-white rounded text-lg justify-center items-center"
        >
          <div className="pr-3 group hover:stroke-white">
          <svg
          ...
          <div className=" font-bold font-mono">Reset</div>
        </button>
      </div>
      <div className="p-2">
        <button
